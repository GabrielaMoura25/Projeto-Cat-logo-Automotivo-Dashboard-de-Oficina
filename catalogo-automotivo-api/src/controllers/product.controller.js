...
const { produtoSchema, produtoUpdateSchema } = require("../utils/product.validation");
...
const atualizarProduto = async (req, res) => {
    try {
        ...
        const categoriaFinal = value.categoria !== undefined ? value.categoria : existente.categoria;
        if ((value.nome && value.nome !== existente.nome) || (value.categoria && value.categoria !== existente.categoria)) {
            const novaDescricao = await gerarDescricaoComRetry(nomeFinal, categoriaFinal);
        ...
        const produto = {
            ...
            aplicacao_veicular: value.aplicacao_veicular !== undefined ? value.aplicacao_veicular : existente.aplicacao_veicular,
            descricao,
        };
...
module.exports = { criarProduto, listarProdutos, buscarProdutos, atualizarProduto };
